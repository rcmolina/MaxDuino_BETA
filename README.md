...
* V1.43 aka "Mar Menor" version. Implemented half-interval also called logarithmic search for directory searching and block selection. Use root button + FF/REW. 
