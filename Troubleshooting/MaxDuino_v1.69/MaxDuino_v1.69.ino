...
void GetAndPlayBlock()
{
      ...
      while (i< block) {
        if(ReadByte(bytesRead)==1) currentID = outByte;
          switch(currentID) {
            case ID10:  bytesRead+=2;                     
                        if(ReadWord(bytesRead)==2) bytesToRead = outWord +1;
                        break;
            case ID11: 
                        break;
            case ID12: 
            ...
            case ID30:  if (ReadByte(bytesRead)==1) bytesRead += outByte;                                            
                        break;
            case ID31:  if(ReadByte(bytesRead)==1) {}         
            ...
            case ID35:  bytesRead += 0x10;
                        ...
                        break;
            case ID4B:  break;
            case TAP:   if(ReadWord(bytesRead)==2) bytesToRead = outWord+1;
                        break;
          }
          i++; 
      }
