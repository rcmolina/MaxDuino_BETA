  ...
  while(digitalRead(btnStop)==HIGH || lastbtn)
  {
    if(updateScreen) {
      ...
      switch(menuItem) {
        ...
        break;
        case 1:
        printtextF(PSTR("Motor Control   "),lineaxy);
        break;
        case 2:
        ...
        case 0:
          ...
          while(digitalRead(btnStop)==HIGH || lastbtn) {
            if(updateScreen) {
              ...
              switch(subItem) {
                case 0:                                  
                  printtextF(PSTR("1200 Baud       "),lineaxy);
                  if(BAUDRATE==1200) printtextF(PSTR("1200 Baud     * "),lineaxy);
                break;
                case 1:        
                  printtextF(PSTR("2400 Baud       "),lineaxy);
                  if(BAUDRATE==2400) printtextF(PSTR("2400 Baud     * "),lineaxy);
                break;
                case 2:                  
                  printtextF(PSTR("2700 Baud       "),lineaxy);
                  if(BAUDRATE==2700) printtextF(PSTR("2700 Baud     * "),lineaxy);
                break;                  
                case 3:                  
                  printtextF(PSTR("3600 Baud       "),lineaxy);
                  if(BAUDRATE==3600) printtextF(PSTR("3600 Baud     * "),lineaxy);
                break;                
              }
              updateScreen=false;
            }
        ...
        case 1:
          ...
          while(digitalRead(btnStop)==HIGH || lastbtn) {
            if(updateScreen) {
              ...
              switch(subItem) {
                case 0:
                  printtextF(PSTR("Motor Ctrl On   "),lineaxy);
                  if(mselectState==1) printtextF(PSTR("Motor Ctrl On * "),lineaxy);
                break;
                case 1:
                  printtextF(PSTR("Motor Ctrl Off  "),lineaxy);
                  if(mselectState==0) printtextF(PSTR("Motor Ctrl Off *"),lineaxy);
                break;                
              }
              updateScreen=false;
            }
        ...
        case 2:
          ...
          while(digitalRead(btnStop)==HIGH || lastbtn) {
            if(updateScreen) {
              ...
              switch(subItem) {
                case 0:
                  printtextF(PSTR("TSXspeedup Off  "),lineaxy);
                  if(TSXspeedup==0) printtextF(PSTR("TSXspeedup Off *"),lineaxy);
                break;
                case 1:
                  printtextF(PSTR("TSXspeedup On   "),lineaxy);
                  if(TSXspeedup==1) printtextF(PSTR("TSXspeedup On * "),lineaxy);
                break;                
              }
              updateScreen=false;
            }
