#define VERSION "v1.39S MaxDuino"
// ---------------------------------------------------------------------------------
...
void setup() {
    ...
    #if (SPLASH_SCREEN)
        lcd.setCursor(0,0);
        lcd.print("Welcome to"); // Set the text at the initilization for LCD Screen (Line 1)
        lcd.setCursor(0,1); 
        lcd.print("Maxduino"); // Set the text at the initilization for LCD Screen (Line 2)
    #endif
