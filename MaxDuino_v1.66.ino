 ...
 */ 
 ...
 //               V1.66 New userconfig option for optional oled on screen print, so more space for nano to include 
 //                     oric and uef in the same upgrade.
 //
#include <EEPROM.h>
