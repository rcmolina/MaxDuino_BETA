 ...
 */ 
 ...
 //               V1.74 Use SoftI2CMaster instead of Softwire to save more space.
 //
#include <EEPROM.h>
    ...
    //       lcd.print(' ');lcd.print(bytesRead,HEX);
         ...
         //}
            ...
            //  input[0]=48+(block/10)%10;input[1]=48+block%10;input[2]=0;sendStrXY((char *)input,4,0);
              utoa(block, (char *)input, 10);sendStrXY((char *)input,4,0);//sendChar(' ');
              //if (bytesRead > 0){
                
                if (block < 99) sendStrXY(" ID:", 6,0);
                ...
                input[2]=0;
                if (block < 99) sendStrXY((char *)input,10,0);
